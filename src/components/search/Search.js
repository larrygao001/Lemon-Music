			...
			<div className="music-search skin-search">
				<div className="search-box-wrapper skin-search-box-wrapper">
					<div className="search-box skin-search-box">
						...
						<input type="text" className="search-input" placeholder="Search songs, singers, albums" 
						value={this.state.w}
					...
					onClick={() => this.setState({w:"", singer:{}, album:{}, songs:[]})}>Cancel</div>
					...
					<Scroll ref="scroll">
						...
						onClick={this.handleClick(singer.mId, "singer")}>
							...
							<div className="right">
								...
								<div className="info">songs{singer.songnum} Albums{singer.albumnum}</div>
							</div>
						</div>
						{/*Songs List*/}
						{
